...
![Title slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/00-title.png)
...
![Introduction slide 1](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/01-introduction-not-talking-about.png)
![Introduction slide 2](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/02-introduction-will-talk-about.png)
...
![What is FFI slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/03-what-is-ffi.png)
...
![When is rust ok slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/04-when-does-using-rust-make-sense.png)
![When is rust not ok slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/05-when-is-ffi-not-worth-the-hassle.png)
...
![Profiling slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/06-how-do-we-know-what-is-slow.png)
...
![Code example Rust slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/07-code-example-rust.png)
![Code example FFI slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/08-code-example-ffi.png)
![Code example PHP slide](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/09-code-example-php.png)
![Is Rust awkward to write in FFI question](./017-symfony-and-rust-accelerating-hot-paths-with-ffi/10-questions.png)
